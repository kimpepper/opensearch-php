...
- Widen `guzzlehttp/psr7` dev dependency constraint to `^2.8.0 || ^3.0.0` and bump `aws/aws-sdk-php` dev dependency to `^3.394.9` to support Guzzle 8 ([#412](https://github.com/opensearch-project/opensearch-php/issues/412))
### Deprecated
...
### Removed
- Drop CI integration testing against EOL OpenSearch 1.x and legacy Elasticsearch OSS 7.10.0 ([#415](https://github.com/opensearch-project/opensearch-php/issues/415))
### Fixed
...
- Fix newlines in docs ([#382](https://github.com/opensearch-project/opensearch-php/pull/382))
- Allow URL params with the name `type` ([#384](https://github.com/opensearch-project/opensearch-php/pull/384))
### Updated APIs
